...
```json
{
  ...
  "zones": {
    ...
    "items": [
      ...
      { "id": "Z2", "label": "VPC · ap-northeast-1\\n203.0.113.0/24", "color_border": "amber #FBBF24 dashed", "cidr": "203.0.113.0/24" },
      { "id": "Z3", "label": "Public Subnet · 203.0.113.0/26 (AZ-a)", "color_border": "blue #60A5FA dashed", "parent": "Z2" },
      { "id": "Z4", "label": "Private Subnet · 203.0.113.64/26 (AZ-a)", "color_border": "emerald #34D399 dashed", "parent": "Z2" }
    ],
